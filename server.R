...
funcs <- c("4s of batsman","6s of batsman","4s & 6s of batsman","Ground avg of batsman",
            "Avg runs scored vs opposition",
           "Contribution to wins & losses","Batsman's dismissals","batsmanMeanStrikeRate","batsmanMovingAverage",
...
shinyServer(function(input, output,session) {
    ...
    output$distPlot <- renderPlot({  
        ...
        cat(file,"\n")
        funcs <- c("4s of batsman","6s of batsman","batsman4s6s","batsmanAvgRunsGround","batsmanAvgRunsOpposition",
